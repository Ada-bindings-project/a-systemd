...
begin
   ...
   Ada.Text_IO.Put_Line (Systemd.Id128.image (Systemd.Id128.Randomize));
   Ada.Text_IO.Put_Line (Systemd.Id128.image (Systemd.Id128.Get_Machine));
   Ada.Text_IO.Put_Line (Systemd.Id128.image (Systemd.Id128.Null_Id128));
   Ada.Text_IO.Put_Line (Systemd.Id128.image (Systemd.Id128.All_Id128));
