...
package Systemd.daemon is
  ...
  --
   ...
   function is_fifo (fd : int; path : String) return Boolean;
  ...
  --
   ...
   function is_special (fd : int; path : String) return Boolean;
  ...
  --
   ...
   function Is_Mq (Fd : Int; Path : String) return Boolean;
  ...
  --
   ...
   function notify (unset_environment : Boolean := False; state : String) return int;

  --  Similar to notify() but takes a format string.
  ...
  --  exiting, on failure:
  --     notifyf(0, "STATUS=Failed to start up: %s\n"
  --                   "ERRNO=%i",
  --                   strerror(errno),
  --                   errno);
  --  See notifyf(3) for more information.
  --
  ...
  --
   ...
   function watchdog_enabled (unset_environment : Boolean := False; usec : access unsigned_long) return Boolean ;
